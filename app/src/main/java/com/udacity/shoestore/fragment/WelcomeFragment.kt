...
class WelcomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //Get the email to be displayed in textview from Bundle
        val details = getString(R.string.details_text, WelcomeFragmentArgs.fromBundle(requireArguments()!!).email)
        binding.detailsTextview.text=details

        //On clicking next button navigate to Instruction Page
